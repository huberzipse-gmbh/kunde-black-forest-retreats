...
export const de = {
  ...
  bookingFlow: {
    ...
    account: {
      ...
      forgotIntro: 'Gib deine E-Mail-Adresse ein. Wir senden dir einen Link, mit dem du ein neues Passwort vergeben kannst.',
      forgotSubmit: 'Link senden',
      backToLogin: 'Zurück zum Anmelden',
      resetSent: 'Wenn ein Konto zu dieser E-Mail existiert, haben wir dir einen Link zum Zurücksetzen geschickt. Schau auch im Spam-Ordner nach.',
      resetEmail: {
        subject: 'Passwort zurücksetzen · Black Forest Retreats',
        greeting: 'Hallo,',
        intro: 'du möchtest dein Passwort zurücksetzen. Klick auf den Button, um ein neues Passwort zu vergeben.',
        cta: 'Neues Passwort vergeben',
        expiry: 'Der Link ist aus Sicherheitsgründen nur 30 Minuten gültig.',
        ignore: 'Falls du das nicht warst, kannst du diese E-Mail einfach ignorieren.',
      },
      resetPage: {
        title: 'Neues Passwort',
        checking: 'Einen Moment, wir prüfen deinen Link …',
        invalid: 'Dieser Link ist ungültig oder abgelaufen. Fordere bitte einen neuen an.',
        intro: 'Vergib jetzt dein neues Passwort.',
        newPasswordLabel: 'Neues Passwort',
        submit: 'Passwort speichern',
        done: 'Fertig. Dein Passwort ist gesetzt. Du kannst dich jetzt anmelden.',
        toAccount: 'Zum Konto',
        backToLogin: 'Zum Anmelden',
        errGeneric: 'Das hat nicht geklappt. Bitte versuche es erneut.',
      },
    },
    errors: {
